/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/20795*@* */
...
void draw() {
  ...
  rect(rectangleLocationX + 100, rectangleLocationY, rectangleWidth, rectangleHeight);
  ...
  boolean collisionDetected2 = isCollidingCircleRectangle(circleLocationX, circleLocationY, 
    circleRadius, rectangleLocationX + 100, rectangleLocationY, rectangleWidth, rectangleHeight);
