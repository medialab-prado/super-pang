...
//Vars Color Interactions
int maxColors = 10;
color colorPoints = color(maxColors, maxColors, maxColors);
float colorInteraction = 0;
color colorLinesConnect = color(colorInteraction, maxColors, maxColors, maxColors/2);
color colorLinesInterConnect = color(colorInteraction, maxColors, maxColors, maxColors/2);
color colorOSCBlobInteraction = color(maxColors, maxColors, maxColors);
  
////Vars for Mouse Interaction
color colorMouseInteraction = color(maxColors, maxColors, maxColors);
...
void setup() {
  ...
  colorMode(HSB, maxColors, maxColors, maxColors);
  smooth();
